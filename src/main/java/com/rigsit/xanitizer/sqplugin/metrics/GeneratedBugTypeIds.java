...
public class GeneratedBugTypeIds {
	...
	static {
		...
		PRESENTATION_NAMES.put("XPathSearch:sessionConfigWOTrackingModeCookieConfig",
		...
		PRESENTATION_NAMES.put("XPathSearch:sessionConfigMissing",
		...
		PRESENTATION_NAMES.put("XPathSearch:exceptionTypeJavaLangThrowableMissing",
		...
		PRESENTATION_NAMES.put("RegexSearch:CredentialsInJavaSourceFile",
				"Credentials in Java source file");
		GENERATED_BUG_TYPE_IDS.put("GWT:FRAMEWORK_SIMULATION:UnusedRPCMethods", 11);
		PRESENTATION_NAMES.put("GWT:FRAMEWORK_SIMULATION:UnusedRPCMethods",
				"GWT Unused RPC Methods");
		GENERATED_BUG_TYPE_IDS.put("FRAMEWORK_SIMULATION:ExposeRequestAttributesToFreemarker", 12);
		PRESENTATION_NAMES.put("FRAMEWORK_SIMULATION:ExposeRequestAttributesToFreemarker",
		...
		PRESENTATION_NAMES.put("ssl:SpecialMethodOverwriting:SSL/TLSValidation",
		...
		PRESENTATION_NAMES.put("SpecialMethodCall:java.util.Random",
				"'java.util.Random' Used in Project");
		GENERATED_BUG_TYPE_IDS.put("SpecialMethodCall:EncryptionUsedInProject", 18);
		PRESENTATION_NAMES.put("SpecialMethodCall:EncryptionUsedInProject",
		...
		PRESENTATION_NAMES.put("SpecialMethodCall:EncryptionUsedInProjectWOProvider",
		...
		PRESENTATION_NAMES.put("xss:XSSFromRequestUnrendered",
				"XSS Reflected of Unrendered Output");
		...
		PRESENTATION_NAMES.put("idor:InsecureDirectObjectReferences",
		...
		PRESENTATION_NAMES.put("tbv:TrustBoundaryViolationSession",
