...
public class GeneratedBugTypeIds {
    protected static final Map<String, Integer> GENERATED_BUG_TYPE_IDS = new LinkedHashMap<>();
    protected static final Map<String, String> PRESENTATION_NAMES = new LinkedHashMap<>();
    ...
    static {
          ...
          PRESENTATION_NAMES.put("RegexSearch:CredentialsInJavaSourceFile", "entials in Java source file");
